...
function Projects () {
    ...
    <hr></hr>
        <p class="project-box">These are a few demos of some projects. The first one is a README generator where you can answer a few questions and it will automatically produce a readme file for you! </p>
          ...
          <p class="project-box">This was work-day planner that will display information entered as past, present, future, colors to indicate what event is happening and if it has already past or will be occurring.</p>
        ...
        <p className='project-box'>
            When first I first started taking JS classes this was on of our first projects. It was a password generator that would generate a random password based on the criteria that you selected. It was a fun project and I learned a lot about how to use JS to generate random numbers and how to use prompts and alerts to get user input.
        </p>
